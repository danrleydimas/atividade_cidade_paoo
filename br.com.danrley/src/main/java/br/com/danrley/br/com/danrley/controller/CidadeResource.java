...
public class CidadeResource {
	...
	public Cidade obterCidadesPorLatAndLong (@PathVariable Integer lat,@PathVariable Integer longi){
		//List<Cidade> lista =
				Cidade d = cidadeRepo.findOneByLongitudeAndLatitude(cidade.getLatitude(),
				cidade.getLongitude());
